...
export function CampaignMode({ isOpen, onClose }: CampaignModeProps) {
  ...
  const isScenarioUnlocked = (scenario: CampaignScenario) => {
    ...
    return scenario.unlockRequirements.every((req) =>
      completedScenarios.includes(req),
    );
  };
      ...
      >
        <div className="flex justify-between items-start mb-2">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3
                className={`font-semibold ${isCompleted ? "text-green-400" : "text-slate-200"}`}
              >
                {scenario.name}
                {isCompleted && " ✅"}
              </h3>
        ...
        <div className="space-y-2">
          ...
          {scenario.restrictions && (
            <div className="text-xs text-red-400">
              ...
              {scenario.restrictions.timeLimit &&
                ` ${scenario.restrictions.timeLimit} day limit`}
