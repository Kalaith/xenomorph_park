...
const campaignScenarios: CampaignScenario[] = [
  {
    ...
    description:
      'Learn the basics of park management by building your first small-scale xenomorph exhibition.',
    difficulty: 'Tutorial',
    biome: 'earth_colony',
    objectives: [
      {
        id: 'build_power',
        description: 'Build a Power Generator',
        type: 'facility',
      ...
      {
        id: 'build_visitor',
        description: 'Build a Visitor Center',
        type: 'facility',
      ...
      {
        id: 'first_drone',
        description: 'Research and place a Drone',
        type: 'species',
        target: 'Drone',
        completed: false,
        required: true,
      ...
      {
        id: 'first_revenue',
        description: 'Earn 2000 credits total',
        type: 'revenue',
        target: 2000,
        completed: false,
        required: true,
      ...
      {
        id: 'visitor_satisfaction',
        description: 'Maintain 20+ visitors',
        type: 'visitors',
        target: 20,
        completed: false,
        required: false,
      ...
      {
        id: 'survive_days',
        description: 'Survive 3 days without major incidents',
        type: 'time',
        target: 3,
        completed: false,
        required: true,
    ...
    rewards: {
      credits: 3000,
      research: 750,
      unlockedSpecies: ['Warrior'],
      unlockedFacilities: ['Security Station'],
    },
  },
  {
    ...
    description:
      'Weyland-Yutani has approved expansion. Build a larger facility and attract more dangerous specimens.',
    difficulty: 'Easy',
    biome: 'earth_colony',
    objectives: [
      {
        id: 'security_station',
        description: 'Build a Security Station',
        type: 'facility',
        target: 'Security Station',
        completed: false,
        required: true,
      },
      {
        id: 'containment_units',
        description: 'Build 2 Containment Units',
        type: 'facility',
        target: 2,
        completed: false,
        required: true,
      ...
      {
        id: 'multiple_species',
        description: 'House 3 different species simultaneously',
        type: 'species',
        target: 3,
        completed: false,
        required: true,
      ...
      {
        id: 'research_warrior',
        description: 'Research Warrior xenomorph',
        type: 'research',
        target: 'Warrior',
        completed: false,
        required: true,
      ...
      {
        id: 'visitor_capacity',
        description: 'Accommodate 75+ visitors',
        type: 'visitors',
        target: 75,
        completed: false,
        required: true,
      ...
      {
        id: 'profit_margin',
        description: 'Achieve 1000 daily profit',
        type: 'revenue',
        target: 1000,
        completed: false,
        required: true,
      ...
      {
        id: 'zero_incidents',
        description: 'Operate 7 days without containment breaches',
        type: 'time',
        target: 7,
        completed: false,
        required: false,
    ...
    rewards: {
      credits: 8000,
      research: 1500,
      unlockedSpecies: ['Runner', 'Spitter'],
      unlockedFacilities: ['Medical Bay', 'Cafeteria'],
    },
  },
  {
    id: 'hadleys_hope',
    ...
    description:
      "Recreate the infamous Hadley's Hope colony. Manage a research station while studying aggressive specimens.",
    difficulty: 'Medium',
    biome: 'lv_426',
    objectives: [
      {
        id: 'atmospheric_processor',
        description: 'Build an Atmospheric Processor',
        type: 'facility',
        target: 'Atmospheric Processor',
        completed: false,
        required: true,
      },
      {
        id: 'research_facility',
        description: 'Establish advanced research capabilities',
        type: 'research',
        target: 3000,
        completed: false,
        required: true,
      ...
      {
        id: 'contain_warriors',
        description: 'Successfully contain 3 different warrior-class species',
        type: 'species',
        target: 3,
        completed: false,
        required: true,
      ...
      {
        id: 'weather_survival',
        description: 'Survive 3 atmospheric storm events',
        type: 'survival',
        target: 3,
        completed: false,
        required: true,
      ...
      {
        id: 'colony_population',
        description: 'Support 100+ colonist simulation',
        type: 'visitors',
        target: 100,
        completed: false,
        required: true,
      ...
      {
        id: 'terraforming_success',
        description: 'Operate for 15 days with stable conditions',
        type: 'time',
        target: 15,
        completed: false,
        required: true,
      ...
      {
        id: 'perfect_safety',
        description: 'Zero colonist casualties',
        type: 'survival',
        target: 0,
        completed: false,
        required: false,
    ...
    restrictions: {
      maxFacilities: 18,
      timeLimit: 25,
      forbiddenSpecies: ['Queen', 'Empress'],
    },
    unlockRequirements: ['corporate_expansion'],
    rewards: {
      credits: 15000,
      research: 3000,
      unlockedSpecies: ['Praetorian', 'Lurker'],
      unlockedFacilities: ['Atmospheric Processor', 'Observatory'],
    },
  },
  {
    ...
    description:
      'A survival horror scenario. Your ship has been compromised. Survive and contain the threat.',
    difficulty: 'Hard',
    biome: 'space_station',
    objectives: [
      {
        id: 'survive_alien',
        description: 'Survive alien encounter',
        type: 'survival',
        target: 1,
        completed: false,
        required: true,
      ...
      {
        id: 'repair_systems',
        description: 'Repair critical systems',
        type: 'facility',
        target: 'Life Support',
        completed: false,
        required: true,
    ...
    rewards: {
      credits: 15000,
      research: 3000,
      unlockedSpecies: ['Neomorph'],
      unlockedFacilities: ['Emergency Systems'],
    },
  },
  {
    ...
    description:
      'Corporate demands a massive exhibition showcasing all species. Spare no expense, but maintain perfect security.',
    difficulty: 'Hard',
    biome: 'earth_colony',
    objectives: [
      {
        id: 'all_species',
        description: 'Display all available species',
        type: 'species',
        target: 10,
        completed: false,
        required: true,
      ...
      {
        id: 'massive_revenue',
        description: 'Generate 50,000 total revenue',
        type: 'revenue',
        target: 50000,
        completed: false,
        required: true,
      ...
      {
        id: 'vip_visitors',
        description: 'Accommodate 200+ visitors',
        type: 'visitors',
        target: 200,
        completed: false,
        required: true,
      ...
      {
        id: 'perfect_record',
        description: 'Zero visitor casualties',
        type: 'survival',
        target: 0,
        completed: false,
        required: true,
    ...
    rewards: {
      credits: 100000,
      research: 10000,
      unlockedFacilities: ['Executive Suite', 'Corporate Laboratory'],
    },
  },
  {
    id: 'alien_homeworld',
    ...
    description:
      'Establish a research outpost on the xenomorph homeworld. Face unknown species and hostile environment.',
    difficulty: 'Nightmare',
    biome: 'xenomorph_prime',
    objectives: [
      {
        id: 'establish_base',
        description: 'Build 20 facilities',
        type: 'facility',
        target: 20,
        completed: false,
        required: true,
      ...
      {
        id: 'discover_species',
        description: 'Discover 5 new species',
        type: 'research',
        target: 5,
        completed: false,
        required: true,
      ...
      {
        id: 'survive_waves',
        description: 'Survive 5 alien attack waves',
        type: 'survival',
        target: 5,
        completed: false,
        required: true,
      ...
      {
        id: 'genetic_mastery',
        description: 'Create 10 genetic modifications',
        type: 'research',
        target: 10,
        completed: false,
        required: true,
    ...
    rewards: {
      credits: 200000,
      research: 20000,
      unlockedSpecies: ['Alpha Xenomorph', 'Empress'],
      unlockedFacilities: ['Xenomorph Shrine', 'Hive Mind Interface'],
    },
  },
];
  ...
  const ScenarioCard = ({ scenario }: { scenario: CampaignScenario }) => {
    ...
    return (
      ...
      >
        ...
        <p className="text-slate-300 text-sm mb-3 leading-relaxed">{scenario.description}</p>

        <div className="space-y-2">
          <div className="text-xs text-slate-400">
            <strong>Objectives:</strong> {scenario.objectives.filter(obj => obj.required).length}{' '}
            required, {scenario.objectives.filter(obj => !obj.required).length} optional
          </div>
          ...
          {scenario.restrictions && (
            <div className="text-xs text-red-400">
              ...
              {scenario.restrictions.maxFacilities &&
                ` Max ${scenario.restrictions.maxFacilities} facilities`}
          ...
          <div className="text-xs text-green-400">
            ...
            {scenario.rewards.unlockedSpecies &&
              ` +${scenario.rewards.unlockedSpecies.length} species`}
            {scenario.rewards.unlockedFacilities &&
              ` +${scenario.rewards.unlockedFacilities.length} facilities`}
          </div>
        </div>
      </div>
    );
          ...
          <div className="flex items-center gap-4">
            <div className="text-sm">
              ...
              <span className="text-green-400 ml-2">
                {completedScenarios.length}/{campaignScenarios.length}
              </span>
            </div>
            <div className="flex-1 bg-slate-700 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${(completedScenarios.length / campaignScenarios.length) * 100}%`,
                }}
              />
            </div>
          </div>
        ...
        {selectedScenario && (
          <div className="bg-slate-800/50 p-4 rounded-lg border border-green-400">
            <h4 className="text-green-400 font-semibold mb-3">
              Mission Briefing: {selectedScenario.name}
            </h4>
