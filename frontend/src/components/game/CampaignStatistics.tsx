            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-600">
                  <div className="text-2xl mb-2">⚡</div>
                  <div
                    className={`text-2xl font-bold ${getPerformanceColor(getPerformanceRating())}`}
                  >
                ...
                <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-600">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-slate-200">
                        {formatNumber(statistics.facilitiesBuilt || 0)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-400">Species Contained:</span>
                      <span className="text-slate-200">
                        {formatNumber(statistics.speciesContained || 0)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-400">Crises Handled:</span>
                      <span className="text-slate-200">
                        {formatNumber(statistics.crisisesHandled || 0)}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              {achievements.length > 0 ? (
                <div className="grid gap-4">
                  {achievements.map((achievement, index) => (
                    <div
                      key={index}
                      className="p-4 bg-slate-800/50 rounded-lg border border-yellow-500/30"
                    >
                    ...
                    <div>
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="text-green-400">
                          {completionData.completionRate.toFixed(1)}%
                        </span>
                      </div>
