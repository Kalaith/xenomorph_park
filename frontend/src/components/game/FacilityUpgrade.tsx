  ...
  "Research Lab": [
    {
      ...
      description:
        "Install cutting-edge research equipment for faster analysis",
      cost: 2000,
      requirements: [],
...
export function FacilityUpgrade({
  isOpen,
  facility,
  onClose,
  ...
  const [selectedUpgrade, setSelectedUpgrade] =
    useState<UpgradeDefinition | null>(null);
  ...
  const getUpgradeStatus = (
    ...
    if (!upgrade.requirements.every((req) => facilityUpgrades.includes(req)))
      return "locked";
    return "available";
  };
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <span className="text-purple-400">
                💰 {facility.cost + totalUpgradeCost}
              </span>
            </div>
          </div>
            ...
            return (
              <PulseEffect key={upgrade.id} pulse={isSelected} color="green">
                <div
                  ...
                  `}
                  onClick={() =>
                    status === "available" ? setSelectedUpgrade(upgrade) : null
                  }
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      {upgrade.requirements.length > 0 && (
                        <div className="mb-3">
                          ...
                          {upgrade.requirements.map((req) => {
                            const reqUpgrade = availableUpgrades.find(
                              (u) => u.id === req,
                            );
                      ...
                      {/* Benefits */}
                      <div className="flex flex-wrap gap-2">
                        {Object.entries(upgrade.benefits).map(
                          ([benefit, value]) => (
                            <span
                              key={benefit}
