                    ...
                    content={
                      <div className="space-y-2">
                        ...
                        <div className="text-xs border-t border-slate-600 pt-2">
                          <div>
                            Cost: {trait.cost} 💰 + {Math.floor(trait.cost / 10)} 🔬
                          </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex justify-between items-center">
                        ...
                        <div className="text-xs text-yellow-400">{trait.cost} 💰</div>
                      </div>
                    </button>
                  </Tooltip>
                );
              ...
              return preview ? (
                <div className="bg-slate-800/50 p-3 rounded border border-slate-600">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2 text-xs">
                    <div>
                      Danger Level: <span className="text-red-400">{preview.dangerLevel}</span>
                    </div>
                    <div>
                      Containment:{' '}
                      <span className="text-orange-400">{preview.containmentDifficulty}</span>
                    </div>
                    <div>
                      Food: <span className="text-blue-400">{preview.foodRequirement}</span>
                    </div>
                    <div>
                      Research Cost: <span className="text-yellow-400">{preview.researchCost}</span>
                    </div>
                  </div>
                  <div className="mt-2">
          ...
          <div className="bg-slate-800/30 p-3 rounded border border-slate-600">
            ...
            <div className="text-sm space-y-1">
              <div className="flex justify-between">
                <span>Credits:</span>
                <span
                  className={resources.credits >= totalCost ? 'text-green-400' : 'text-red-400'}
                >
                  {totalCost} 💰
                </span>
              </div>
              <div className="flex justify-between">
                ...
                <span
                  className={
                    resources.research >= totalResearchCost ? 'text-green-400' : 'text-red-400'
                  }
                >
                  {totalResearchCost} 🔬
                </span>
