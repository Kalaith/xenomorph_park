        ...
        <Tooltip
          content={
            <TooltipContent
              ...
              stats={[
                { label: 'Current', value: resources.credits.toLocaleString(), color: 'text-green-400' },
                { label: 'Daily Revenue', value: `+${resources.dailyRevenue.toLocaleString()}`, color: 'text-green-400' },
                { label: 'Daily Expenses', value: `-${resources.dailyExpenses.toLocaleString()}`, color: 'text-red-400' },
              ]}
            />
          }
          rich={true}
        ...
        <Tooltip
          content={
            <TooltipContent
              ...
              stats={[
                { label: 'Used', value: `${resources.power}/${resources.maxPower}`, color: resources.power >= resources.maxPower ? 'text-red-400' : 'text-yellow-400' },
                { label: 'Utilization', value: `${Math.round((resources.power / resources.maxPower) * 100)}%` },
              ]}
              actions={[
        ...
        <Tooltip
          content={
            <TooltipContent
              ...
              stats={[
                { label: 'Available', value: resources.research, color: 'text-blue-400' },
              ]}
              actions={[
                { label: 'Build Research Labs to generate more' }
              ]}
            />
          }
          rich={true}
        ...
        <Tooltip
          content={
            <TooltipContent
              ...
              actions={[
                { label: 'Build Security Stations to increase' }
              ]}
            />
          }
          rich={true}
        ...
        <Tooltip
          content={
            <TooltipContent
              ...
              stats={[
                { label: 'Current', value: `${resources.visitors}/${resources.maxVisitors}`, color: 'text-purple-400' },
                { label: 'Capacity', value: `${Math.round((resources.visitors / resources.maxVisitors) * 100)}%` },
              ]}
              actions={[
        ...
        <Tooltip
          content={
            <TooltipContent
              ...
              stats={[
                { label: 'Revenue', value: `+$${resources.dailyRevenue.toLocaleString()}`, color: 'text-green-400' },
                { label: 'Expenses', value: `-$${resources.dailyExpenses.toLocaleString()}`, color: 'text-red-400' },
                { label: 'Net', value: `$${(resources.dailyRevenue - resources.dailyExpenses).toLocaleString()}`, color: (resources.dailyRevenue - resources.dailyExpenses) >= 0 ? 'text-green-400' : 'text-red-400' },
              ]}
            />
          }
          rich={true}
