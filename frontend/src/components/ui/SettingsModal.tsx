            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <select
                  ...
                  onChange={e =>
                    handleSettingChange('gridSize', e.target.value as GameSettings['gridSize'])
                  }
                  className="bg-slate-700 border border-slate-600 text-slate-300 rounded px-2 py-1"
                >
              ...
              <div className="flex items-center justify-between">
                ...
                <select
                  ...
                  onChange={e =>
                    handleSettingChange('language', e.target.value as GameSettings['language'])
                  }
                  className="bg-slate-700 border border-slate-600 text-slate-300 rounded px-2 py-1"
                >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <select
                  ...
                  onChange={e =>
                    handleSettingChange('theme', e.target.value as GameSettings['theme'])
                  }
                  className="bg-slate-700 border border-slate-600 text-slate-300 rounded px-2 py-1"
                >
        ...
        {activeTab === 'saves' && (
          <div className="space-y-6">
            <div className="space-y-4">
                  ...
                  {getAllSaves().map(save => (
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        <Button size="sm" variant="outline" onClick={() => loadGame(save.id)}>
                          Load
                        </Button>
                        <Button
                          size="sm"
              ...
              <div className="flex gap-2">
                <Button variant="outline" onClick={() => saveManager.cleanupOldSaves()}>
                  🧹 Cleanup Old Saves
                </Button>
