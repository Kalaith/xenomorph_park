...
export const xenomorphSpecies: XenomorphSpecies[] = [
  ...
  },
  {
    name: "Empress",
    description:
      "Super-Queen capable of producing multiple egg sacs simultaneously",
    dangerLevel: 10,
  ...
  // Hybrid Species
  {
    name: "Xeno-Engineer",
    description:
      "Hybrid created from Engineer host with advanced technology integration",
    dangerLevel: 8,
    containmentDifficulty: 9,
    researchCost: 3000,
    foodRequirement: "Very High",
...
export const facilityDefinitions: FacilityDefinition[] = [
  ...
  // Advanced Specialized Facilities
  {
    ...
    powerRequirement: 15,
    description:
      "Terraforming facility for environmental control and weather manipulation",
  },
  {
    ...
    powerRequirement: 12,
    description:
      "Advanced research facility with classified experimentation capabilities",
  },
  {
    ...
    powerRequirement: 5,
    description:
      "Luxury accommodations for VIP visitors and corporate executives",
  },
  {
  ...
  },
  {
    ...
    powerRequirement: 25,
    description:
      "Experimental technology for communicating with the hive consciousness",
  },
  // Environmental Facilities
  {
    ...
    powerRequirement: 10,
    description:
      "Ultra-low temperature preservation for specimens and research",
  },
  {
  ...
  // Medical & Support
  {
    ...
    powerRequirement: 6,
    description:
      "Advanced medical facility for treating injuries and infections",
  },
  {
    name: "Cafeteria",
    cost: 8000,
    powerRequirement: 4,
    description:
      "Dining facility that improves visitor satisfaction and dwell time",
  },
  {
    name: "Observatory",
    cost: 12000,
    powerRequirement: 5,
    description:
      "Astronomical monitoring station for tracking external threats",
  },
  {
  ...
  },
  {
    ...
    powerRequirement: 22,
    description:
      "Research facility for studying telepathic and psychic phenomena",
  },
