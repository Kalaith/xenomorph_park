...
export const researchTree: ResearchNode[] = [
  // TIER 1 - Basic Research
  {
    ...
    description:
      "Fundamental understanding of xenomorph physiology and behavior",
    category: "basic",
    tier: 1,
    icon: "🔬",
  ...
  // TIER 2 - Intermediate Research
  {
    ...
    description:
      "Study of aggressive xenomorph variants and their combat adaptations",
    category: "biology",
    tier: 2,
    icon: "⚔️",
  ...
  },
  {
    ...
    description:
      "Advanced materials and designs for containing aggressive species",
    category: "containment",
    tier: 2,
    icon: "🏢",
  ...
  // TIER 3 - Advanced Research
  {
    ...
    description:
      "Understanding facehugger behavior and chestburster development",
    category: "breeding",
    tier: 3,
    icon: "🕷️",
  ...
  },
  {
    ...
    description:
      "Ultimate containment measures for the most dangerous specimens",
    category: "containment",
    tier: 4,
    icon: "🔐",
...
export function updateResearchAvailability(
  nodes: ResearchNode[],
): ResearchNode[] {
  return nodes.map((node) => {
    ...
    const allPrereqsCompleted = node.prerequisites.every(
      (prereqId) => nodes.find((n) => n.id === prereqId)?.completed ?? false,
    );
